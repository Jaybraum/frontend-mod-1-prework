...
for (var i = 10; i < frog.length; i--) {
  if (i > 0) {
    ...
    console.log(+[i] + " speckled frog sat on a log eating some most delicious bugs. One jumped in the pool where its nice and cool, then there were no more speckled frogs!");break;
  }
}console.log(frog[i]);
