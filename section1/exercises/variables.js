...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
/* I defined each data type by the value added. For firstName I used a String because
the value used letters, isHungry is a Boolean asking a question so it can only be defines
as true or false, and finally numberOfPets asks for numbers so the value would be an integer */
